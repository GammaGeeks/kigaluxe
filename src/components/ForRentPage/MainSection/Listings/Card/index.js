  ...
  return (
    <Col xs={12} sm={6} md={4} lg={3} className='mt-4'>
      <div className="card" style={{borderRadius: '10px'}}>
        <Image style={{borderTopLeftRadius: '10px', borderTopRightRadius: '10px'}} src={require('../../../../../assets/HouseOne 2.png')} className="card-img-top" alt="image_property" />
        <div className='d-flex flex-column-reverse' style={{position: 'absolute', top: 5, right: 5}}>
          <Button className='share_button'><Image style={{width: '20px', height: '20px'}} src={shareSVG} alt='image_svg' /></Button>
          <Button className='share_button'><FontAwesomeIcon icon={faFacebook} /></Button>
          <Button className='share_button'><FontAwesomeIcon icon={faInstagram} /></Button>
          <Button className='share_button'><FontAwesomeIcon icon={faWhatsapp} /></Button>
          <Button className='share_button'><FontAwesomeIcon icon={faTiktok} /></Button>
        </div>
        <div className="card-body details_area">
          <div className='d-flex gap-2'>
            <div className='d-flex justify-content-center align-items-center'><Badge style={{lineHeight: '15px'}} className='price'>RWF 200,000,000</Badge></div>
            <div className='d-flex justify-content-center align-items-center'><Badge className='images'><Image style={{width: '15px'}} src={imageSVG} alt='image_svg' /> 10</Badge></div>
          </div>
          <div className='title'>Lorem ipsum consectetur dolor sit amet</div>
          <div className='d-flex justify-content-between gap-2 mb-2'>
            ...
            <div className='d-flex justify-content-center align-items-center gap-2'>
              <Badge className='for_rent'>
                {/* <Image style={{width: '15px'}} src={imageSVG} alt='image_svg' /> */}
                 For Rent 
              </Badge>
              <Badge className='for_sale'>
                {/* <Image style={{width: '15px'}} src={imageSVG} alt='image_svg' /> */}
                 For Sale 
              </Badge>
            </div>
          ...
          <div style={{border: '1px solid #ccc', borderRadius: '7px', padding: '5px'}} className='d-flex justify-content-between'>
            ...
            <Stack direction="horizontal" gap={3}>
              <div className="p-2 area"><Image style={{width: '18px'}} src={sqmSVG} alt='sqm_svg' /> 3 sqm</div>
              <div className="p-2 ms-auto bathroom">
                <Image style={{width: '18px'}} src={bathroomSVG} alt='bathroom_svg' /> 6
              </div>
              <div className="p-2 bedroom">
                <Image style={{width: '18px'}} src={bedroomSVG} alt='bedroom_svg' /> 2
              </div>
              <div className="p-2 pool">
              <Image style={{width: '18px'}} src={poolSVG} alt='pool_svg' /> 6
              </div>
            </Stack>
          </div>
